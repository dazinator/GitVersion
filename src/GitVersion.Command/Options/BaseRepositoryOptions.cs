namespace GitVersion.Command
{
    ...
    public abstract class BaseRepositoryOptions : VisitableCommandOptions
    {
        [Option('b', "branch", Required = false, Default = "master", HelpText = "The branch to calculate the version number for.")]
